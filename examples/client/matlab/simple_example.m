...
while 1
    ...
    if size(input.models.traffic_lights)
    
        vehicle_position_on_route = input.vehicle_state.position_on_route;
        next_traffic_light_position = input.models.traffic_lights(1).position_on_route;
        ...
        if input.models.traffic_lights(1).state == "red" && distance_to_next_traffic_light < 30
